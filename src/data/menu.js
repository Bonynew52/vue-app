...
const MONTHLY_SPECIALS = [
  {
    name: 'Nuevo - Hogwarts llego a Belly Monster',
    sourceName: 'Hogwarts llego a Belly Monster',
    description: 'Especial de temporada.',
    sku: 'NUEVO-HOGWARTS-LLEGO-BELLY-MONSTER',
    menuId: 'comidas',
    categoryName: 'Lo nuevo',
    image: '/images/menu/nuevo-hogwarts-llego-belly-monster.jpg',
  },
  {
    name: 'Nuevo - Butterbeer Shake',
    sourceName: 'Butterbeer Shake',
    description: 'Especial de temporada.',
    sku: 'NUEVO-BUTTERBEER-SHAKE',
    menuId: 'bebidas',
    categoryName: 'Malteadas',
    image: '/images/menu/nuevo-butterbeer-shake.jpg',
  },
  {
    name: 'Nuevo - Butterbeer Cookie',
    sourceName: 'Butterbeer Cookie',
    description: 'Especial de temporada.',
    sku: 'NUEVO-BUTTERBEER-COOKIE',
    menuId: 'postres',
    categoryName: 'Galletas',
    image: '/images/menu/nuevo-butterbeer-cookie.jpg',
  },
  {
    name: 'Nuevo - Hogwarts Cupcakes',
    sourceName: 'Hogwarts Cupcakes',
    description: 'Especial de temporada.',
    sku: 'NUEVO-HOGWARTS-CUPCAKES',
    menuId: 'postres',
    categoryName: 'Postres',
    image: '/images/menu/nuevo-hogwarts-cupcakes.jpg',
  },
  {
    name: 'Nuevo - Pociones',
    sourceName: 'Pociones',
    ...
    image: '/images/menu/nuevo-potions.jpg',
  },
]
