...
The v0.4.6 APK uses iMin SDK V1.3.1 with the documented USB path for D4 / Android 11 devices. Runtime diagnostics remain available through Android Logcat and the on-screen test log. Config shows the active backend routes used by the agent.
